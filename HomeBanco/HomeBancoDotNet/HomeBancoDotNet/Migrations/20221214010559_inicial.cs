...
namespace HomeBancoDotNet.Migrations
{
    /// <inheritdoc />
    public partial class inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "idUsuario", "apellido", "bloqueado", "dni", "intentos", "isAdmin", "mail", "nombre", "password" },
                values: new object[,]
                {
                    { 1, "perez", false, 31859480, 0, true, "jose@jose.com.ar", "Jose", "1234" },
                    { 2, "Upalala", false, 31859481, 0, false, "Carlos@Upalala.com.ar", "Carlos", "1234" },
                    { 3, "Lagonegro", false, 35147312, 0, true, "111@111", "adrian", "123" },
                    { 4, "Eltoga", true, 35147313, 0, true, "222@222", "Moro", "123" }
                });
