...
namespace HomeBancoDotNet.Migrations
{
    ...
    [Migration("20221213181256_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.CajaDeAhorro", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.Movimiento", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.Pago", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.PlazoFijo", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.TarjetaDeCredito", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.TitularesRel", b =>
                {
                    b.Property<int>("idTi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.Movimiento", b =>
                {
                    b.HasOne("HomeBancoDotNet.Models.CajaDeAhorro", "caja")
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.Pago", b =>
                {
                    b.HasOne("HomeBancoDotNet.Models.Usuario", "user")
                        .WithMany("pagos")
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.PlazoFijo", b =>
                {
                    b.HasOne("HomeBancoDotNet.Models.Usuario", "titularP")
                        .WithMany("pfs")
                        .HasForeignKey("NumUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.TarjetaDeCredito", b =>
                {
                    b.HasOne("HomeBancoDotNet.Models.Usuario", "titular")
                        .WithMany("tarjetas")
                        .HasForeignKey("NumUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HomeBancoDotNet.Models.TitularesRel", b =>
                {
                    b.HasOne("HomeBancoDotNet.Models.CajaDeAhorro", "ca")
                        .WithMany("UserCajas")
                        .HasForeignKey("idCa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomeBancoDotNet.Models.Usuario", "us")
                        .WithMany("UserCajas")
                        .HasForeignKey("idUs")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
